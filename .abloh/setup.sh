...
# step 1: put the package manager on PATH, for your own lifecycle scripts. From pnpm-lock.yaml, pnpm@9.15.9
corepack enable

# step 2: dependencies, from your lockfile. From pnpm-lock.yaml, pnpm@9.15.9
corepack pnpm install --frozen-lockfile

# step 3: your build. From ci.yml::test_matrix
pnpm run build
